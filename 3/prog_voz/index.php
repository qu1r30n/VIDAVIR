...
if (isset($_SESSION["ger"])) {
	if($_SESSION["ger"]==3)
	{
		...
		$arr_nom_btn[0]="reconocimient original"; $arr_pos_grup[0]="0"; $arr_url[0]="bueno";
...
<!------------------------------>
			...
			<input type="text" class="speech-input" placeholder="¿Qué tal?" data-ready="Habla ahora" name="spa-input" lang="es-ES">
			<button id="miboton">grabar</button>
